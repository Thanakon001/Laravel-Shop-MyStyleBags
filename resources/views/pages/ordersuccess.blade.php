...
<div class="row bg-white py-2 rounded-1 shadow-sm">
    <p class="fs-5">จัดการข้อมูลออเดอร์สั่งสินค้า <span class="badge bg-success">จัดส่งสินค้าแล้ว</span></p>
        ...
        <tbody>
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td><span class="badge bg-success text-white fs-6">{{$order->order_status}}</span></td>
