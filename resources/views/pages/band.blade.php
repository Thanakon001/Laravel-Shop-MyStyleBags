...
<div class="d-flex justify-content-between">
    ...
    <a href="{{route('band.create')}}" class="btn btn-success text-white shadow-sm animate__animated animate__fadeInRight">
        ...
        <tbody>
            @foreach ($bands as $band)
                <tr>
                    ...
                    <td>{{$band->products_count}}</td>
                    <td>
                        <a class="text-bg-warning p-1 rounded-1 text-white"
                            href="{{route('band.edit', $band->band_id)}}">แก้ไขที่นี่</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
